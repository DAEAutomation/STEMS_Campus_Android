                    ...
                    Column (modifier = Modifier.fillMaxSize().verticalScroll(rememberScrollState())){
                        ...
                        grouped.forEach { (ym, items) ->
                            ...
                            items.forEachIndexed { index, item ->
                                ...
                                disbursementHistoryRow(item = item, shape = shape, rowClick = { detail -> rowClickHandled(detail) })
...
@Composable
private fun disbursementHistoryPreview() {

// 創建一個模擬的 NavController
    val navController = TestNavHostController(LocalContext.current)
    disbursementHistoryContent (navController,{}, emptyList(),{})
}